...
This section together with section \ref{model_creation} might be the heart of this article. A ready who knows nothing about stability and naively starts implementing a posed model will soon or later recognize and honor the importance of stability considerations.\\
We are going to explain only the important snippets of code. For a detailed view or for using as starting point the code can be cloned from here
 \url{https://github.com/applied-math-coding/basic-diffusion-transport}.
An online running example can be found here,
 \url{https://applied-math-coding.github.io/basic-diffusion-transport/}.

//TODO
describe along with (\ref{final_scheme_expr})
